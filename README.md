...
[![PyPI](https://img.shields.io/pypi/v/git-regret?style=flat&color=orange&logo=pypi&logoColor=white)](https://pypi.org/project/git-regret)
[![Downloads](https://img.shields.io/pypi/dm/git-regret?style=flat&color=brightgreen&label=installs)](https://pypi.org/project/git-regret)
[![Stars](https://img.shields.io/github/stars/yourname/git-regret?style=flat&color=yellow&logo=github)](https://github.com/yourname/git-regret)
[![Issues](https://img.shields.io/github/issues/yourname/git-regret?style=flat&color=red)](https://github.com/yourname/git-regret/issues)
